...
export const NavBar = () => {
    ...
    return (
        <div>
            <header 
            className={`py-6 px-10 fixed top-0 w-full justify-between z-40 text-white transition-all duration-300 ease-in-out ${
                            ...
                            <div id="menu" className={`fixed top-0 right-0 flex flex-col h-screen pt-6 bg-white text-black ${isMenu ? styles['menu-overlay'] : styles['menu-overlay-close']}`}>
                                ...
                                <nav className="text-3xl mx-20">
                                    ...
                                    <ul className="mt-12 [&>li>a]:text-current [&>li>a]:font-bold [&>li>a]:block [&>li>a]:pr-32 [&>li>a]:py-4">
                                        ...
                                        <li>
                                        <Link href="/nosotros" className="hover:text-[#C91E7B]">
                                            Nosotros
                                        </Link>
                                        </li>
                                        <li>
                                        <Link href="/desarrollos" className="hover:text-[#C91E7B]">
                                            Desarrollos
                                        </Link>
                                        </li>
                                        <li>
                                        {/* <Link href="/blog" className="hover:text-[#C91E7B]">
                                            Blog
                                        </Link> */}
                                        </li>
                                        <li>
